...
<div>
  <main>
    ...
    <p class="description">
      Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://trichter.sentry.io/issues/?project=4509610913366096">Issues Page</a>. 
